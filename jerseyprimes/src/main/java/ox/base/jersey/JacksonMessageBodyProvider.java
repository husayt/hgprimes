...
//    private static final Class<?>[] DEFAULT_GROUP_ARRAY = new Class<?>[]{Default.class};
    ...
    public JacksonMessageBodyProvider() {
        ...
        ObjectMapper mapper = JacksonConfigurator.getObjectMapper();
    ...
    public Object readFrom(Class<Object> type,
        ...
        return this.validate(annotations, super.readFrom(type,
                genericType,
                annotations,
                mediaType,
                httpHeaders,
...
//            }
    ...
    private static Class<?>[] findValidationGroups(Annotation... annotations) {
        for (Annotation annotation : annotations) {
//            if (Valid.class.equals(annotation.annotationType())) {
//                return DEFAULT_GROUP_ARRAY;
//            } else if (Validated.class.equals(annotation.annotationType())) {
...
//            }
    ...
    private static boolean isProvidable(Class<?> type) {
